...
import com.example.tptekup.Repositories.RoleRepository;
import com.example.tptekup.Repositories.UserRepository;
import com.example.tptekup.Request.LoginRequest;
import com.example.tptekup.Response.JwtResponse;
import com.example.tptekup.Services.RefreshTokenService;
import com.example.tptekup.JWT.UserDetailsImpl;
import com.example.tptekup.Response.MessageResponse;
...
public class AuthController {
    ...
    @PostMapping("/signup")
    public ResponseEntity<?> registerUser(@Valid @RequestBody com.example.tptekup.Request.SignupRequest signUpRequest) {
        ...
        if (strRoles == null) {
            ...
            strRoles.forEach(role -> {
                switch (role) {
                    ...
                    default:
                        Role userRole = roleRepository.findByName(ERole. ROLE_PROVIDER)
                                .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
                        roles.add(userRole);
                }
            });
